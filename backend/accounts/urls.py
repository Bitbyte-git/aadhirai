...
urlpatterns = [
    ...
    path('shop-hierarchy/', ShopHierarchyView.as_view()),
    path('shop-dashboard-stats/', ShopDashboardStatsView.as_view()),
    path('shop-report/summary/', ShopSalesSummaryView.as_view()),
    ...
    path('superadmin/tier-commission/', TierCommissionView.as_view()),
