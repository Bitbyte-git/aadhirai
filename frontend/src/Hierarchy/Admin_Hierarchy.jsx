...
function showChainPopup(anchorEl, ancestors, current, dark, text, subtext, adminInfo, pinned = false) {
      ...
      >
        ...
        <button
          onClick={e => {
            ...
            showChainPopup(e.currentTarget.closest('.otree-card'), ancestors, { node, role }, dark, text, subtext, adminInfo, true)
          }}
      ...
      <div ref={treeWrapperRef} className="sh-canvas">
        ...
        {loading && (
          <div style={{ display: 'flex', gap: '16px', overflowX: 'auto', paddingBottom: '10px' }}>
            <SkeletonCard color={ROLE_CFG.dealer.color} />
            <SkeletonCard color={ROLE_CFG.dealer.color} />
            <SkeletonCard color={ROLE_CFG.dealer.color} />
          </div>
        )}
