...
function TreeNode({ node, role, depth = 0, dark, text, subtext, ancestors = [], dealerInfo = {}, flatMode = false, parentKey = null, openMap = {}, onToggle = () => {}, onPrint = () => {} }) {
    ...
    try {
      ...
      if (myDealer) {
        setDealerInfo({
          ...
          email: myDealer.email,
        })
        const sdList = myDealer.sub_dealers || []
        setSubDealers(sdList)
        if (sdList.length > 0) {
          setOpenMap({ root: sdList[0].id })
        }
      }
