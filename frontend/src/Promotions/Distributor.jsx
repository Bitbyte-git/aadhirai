  ...
  const downloadReport = async () => {
    ...
    try {
      ...
      const res = await api.post(
        "/generic-table-pdf/",
        {
          title: "Distributor Promotions Report",
          subtitle: "Wholesale Dealers whose downline crossed ₹25,00,000 sales or 30+ customers.",
      ...
      link.setAttribute("download", `distributor_promotions_${new Date().toISOString().slice(0, 10)}.pdf`);
