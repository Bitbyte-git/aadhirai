  ...
  const downloadReport = async () => {
    ...
    try {
      ...
      const res = await api.post(
        "/generic-table-pdf/",
        {
          title: "Retailer Promotions Report",
          subtitle: "Customers whose created sub-customers crossed ₹5,00,000 sales or 7+ customers.",
      ...
      link.setAttribute("download", `retailer_promotions_${new Date().toISOString().slice(0, 10)}.pdf`);
