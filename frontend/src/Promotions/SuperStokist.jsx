  ...
  const downloadReport = async () => {
    ...
    try {
      ...
      const res = await api.post(
        "/generic-table-pdf/",
        {
          title: "Super Stockist Promotions Report",
          subtitle: "Distributors whose downline crossed ₹50,00,000 sales or 50+ customers.",
      ...
      link.setAttribute("download", `super_stockist_promotions_${new Date().toISOString().slice(0, 10)}.pdf`);
