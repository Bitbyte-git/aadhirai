  ...
  const fetchData = async (signal, currentOffset, searchTerm, append, retryCount = 0) => {
    ...
    try {
      const res = await api.get('/hierarchy/tier-directory/', {
        signal,
        params: { role: 'dealer', offset: currentOffset, limit: PAGE_SIZE, search: searchTerm },
      })
      ...
      <div className="mu-shell">
        ...
        <div className="mu-stats-grid">
          ...
          <div
            ...
            onClick={() => navigate('/login-active', { state: { roleFilter: 'Dealer', viewMode: 'active', scopeLabel: 'Distributors' } })}
            title="Open Active Users page filtered to Distributors"
          >
            <div>
          ...
          <div
            className="mu-stat-card"
            style={{ cursor: 'pointer' }}
            onClick={() => navigate('/login-inactive', { state: { roleFilter: 'Dealer', scopeLabel: 'Distributors' } })}
            title="Open Inactive Users page filtered to Distributors"
          >
            <div>
          ...
          <div
            className="mu-stat-card"
            style={{ cursor: 'pointer' }}
            onClick={() => navigate('/hierarchy-sales-count?role=dealer&period=today')}
            title="Open today's order breakdown per Distributor"
          >
            <div>
