...
export default function Wholesale_Dealer() {
  ...
  const exportCSV = () => {
    ...
    const headers = ['S.No', 'Wholesale Dealer ID', 'First Name', 'Last Name', 'Email', 'Mobile', 'City']
    ...
    link.href = url
    link.download = `wholesale_dealers_${new Date().toISOString().slice(0, 10)}.csv`
    document.body.appendChild(link)
    link.click()
    document.body.removeChild(link)
    showToast('Exported Wholesale Dealers CSV')
  }
